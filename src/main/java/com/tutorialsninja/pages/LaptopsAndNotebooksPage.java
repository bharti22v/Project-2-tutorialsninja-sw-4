...
public class LaptopsAndNotebooksPage extends Utility {
    ...
    public void firstNameField() {
        sendTextToElement(firstName, "Bharti");
    }

    public void lastNameField() {
        sendTextToElement(lastName, "Kumawat");
    }

    public void emailFieldText() {
        sendTextToElement(emailField, "sunil123@gmail.com");
    }

    public void telephoneField() {
        sendTextToElement(telephone, "089873456");
    }

    public void address1Field() {
        sendTextToElement(address1, "Rajasthan");
    }

    public void cityFieldText() {
        sendTextToElement(cityField, "Jaipur");
    }

    public void postalCodeField() {
        sendTextToElement(postcode, "09876542");
    }
    ...
    public void regionField() {
        selectByVisibleTextFromDropDown(region, "Rajasthan");
    }
